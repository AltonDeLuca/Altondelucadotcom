export const ProjectsList = [
  ...
  },
  {
    ...
    description: [
      ...
      "This project was initially deployed on a raspberry pi running nodemon out of my home, but due to security concerns and ease of update the project was moved to a virtual private server when it was rebuilt in 2021",
    ],
    img: "",
    imgAlt: "",
  },
  {
    ...
    description: [
      ...
      "Wrote all documents relating to the project, including design documents, and managed sprint tickets",
      "Designed and programmed GUI and built leaderboard component",
    ],
    img: "",
    imgAlt: "",
  },
